...
## Project Structure
    ...
    ├── transportation_prob_41476  # Django project configurations
...
1. Clone this repo and `cd transportation_prob_41476`
...
2. Clone this repo and `cd transportation_prob_41476`
